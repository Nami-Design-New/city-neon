(function ($) {
  ...
  $(".intro-launcher").on("click", function () {
    $(".intro-content-visible").hasClass("hide")
      ? ($(".intro-content-visible").removeClass("hide"),
        $(".intro-content-visible").toggleClass("show"))
      : ($(".intro-content-visible").toggleClass("show"),
        $(".intro-content-visible").addClass("hide"),
        $(".intro-content-visible").addClass("hide"));
  }),
  ...
  $(".about-launcher").on("click", function () {
    $(".about-content-visible").hasClass("hide")
      ? ($(".about-content-visible").removeClass("hide"),
        $(".about-content-visible").toggleClass("show"))
      : ($(".about-content-visible").toggleClass("show"),
        $(".about-content-visible").addClass("hide"),
        $(".about-content-visible").addClass("hide"));
  }),
    $(".about-launcher").on("click", function (e) {
      e.preventDefault(),
        $(this).toggleClass("open"),
        $(".about-content-hidden").toggleClass("show");
    });
